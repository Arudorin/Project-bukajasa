...
// Fetch all companies
$sql = "SELECT id, name FROM users WHERE role = 'Perusahaan'";
            ...
            <table width="1000px" cellspacing="10px">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td width='700px'><a href='admin-perusahaan-about.php?id={$row['id']}'> {$row['name']}</a><hr></td>";
                        echo "<td><a href='delete-company.php?id={$row['id']}' class='hapus'>Hapus</a><hr class='hr'></td>";
                        echo "</tr>";
                    }
                } else {
